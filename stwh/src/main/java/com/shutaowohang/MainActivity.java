    ...
    private void setListener() {
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                switch (position){
                    case 0:radioGroup.check(R.id.main_radiobutton_knowledge_01);
                        break;
                    case 1:radioGroup.check(R.id.main_radiobutton_skill_02);
                        break;
                    case 2:radioGroup.check(R.id.main_radiobutton_book_03);
                        break;
                    case 3:radioGroup.check(R.id.main_radiobutton_message_04);
                        break;
                    case 4:radioGroup.check(R.id.main_radiobutton_me_05);
                        break;
                    default:
                        break;
                }
